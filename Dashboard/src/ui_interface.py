...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_3.addWidget(self.pushButton_6, 0, Qt.AlignHCenter)
...
"border-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 255), stop:1 rgba(255, 255, 255, 255));")
        ...
        sizePolicy4.setHeightForWidth(self.dashboardPage.sizePolicy().hasHeightForWidth())
        self.dashboardPage.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.mainBody_2.sizePolicy().hasHeightForWidth())
        self.mainBody_2.setSizePolicy(sizePolicy5)
...
"")
        ...
        sizePolicy8.setHeightForWidth(self.graph_list.sizePolicy().hasHeightForWidth())
        self.graph_list.setSizePolicy(sizePolicy8)
        self.graph_list.setMinimumSize(QSize(958, 340))
        ...
        sizePolicy4.setHeightForWidth(self.widget_26.sizePolicy().hasHeightForWidth())
        self.widget_26.setSizePolicy(sizePolicy4)
        ...
        self.tableWidget_2 = QTableWidget(self.widget_26)
        ...
        self.label_5 = QLabel(self.packetAnalyzerPage)
        ...
        self.verticalLayout_5.addWidget(self.stackedWidget, 0, Qt.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Packet Analyzer", None))
